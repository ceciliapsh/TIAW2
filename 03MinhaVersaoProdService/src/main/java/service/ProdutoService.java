...
public class ProdutoService {
	...
	public Object add(Request request, Response response) {
		...
		Produto produto = new Produto(id, descricao, fabricante, quantidade, dataFabricacao, dataValidade);
	...
	public Object get(Request request, Response response) {
		...
		if (produto != null) {
            ...
            return "<produto>\n" + 
            		...
            		"\t<fabricante>" + produto.fabricante() + "</preco>\n" +
	...
	public Object update(Request request, Response response) {
        ...
        if (produto != null) {
        	...
        	produto.setFabricante(request.queryParams("fabricante"));
	...
	public Object getAll(Request request, Response response) {
		...
		for (Produto produto : produtoDAO.getAll()) {
			returnValue.append("\n<produto>\n" + 
            		"\t<id>" + produto.getId() + "</id>\n" +
            		"\t<descricao>" + produto.getDescricao() + "</descricao>\n" +
            		"\t<fabricante>" + produto.getFabricante() + "</fabricante>\n" +
            		"\t<quantidade>" + produto.getQuant() + "</quantidade>\n" +
            		"\t<fabricacao>" + produto.getDataFabricacao() + "</fabricacao>\n" +
            		"\t<validade>" + produto.getDataValidade() + "</validade>\n" +
            		"</produto>\n");
